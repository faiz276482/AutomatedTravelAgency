			...
			<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
				...
				<ul class="nav navbar-nav">
				  ...
				  <li class="active"><a href="ridelater.php">Ride Later</a></li>
				</ul>
					...
					<div class="container center_div" >
						...
						<div class="col-md-3 col-sm-3 col-xs-8" ></div>
							<div class="col-md-6 col-sm-6 col-xs-12" style="color:white; background-color:black;opacity:0.8; filter:alpha(opacity:90); border-radius: 5px 15px; ">
							  ...
							  <form action="billgenerate.php" method="post" onclick="return validate()">
											...
											<option value=''>*select Destination</option>
											 ...
											 while($row=mysqli_fetch_array($x)){?>
											  ...
											  <option ><?php echo $row['Source']?></option>
												 ...
												 <span id="dist" ></span>
										<label for="Time">Time: &nbsp;&nbsp;&nbsp;</label><input class="form-control" id="time" type="time" name="time" style="color:black;">                                           
										...
										<div class="form-group" align="center"> <!-- Submit button -->
											<br><br>
											<button class="btn btn-primary " name="submit" type="submit" name="Check_Amount">Check Amount</button>
